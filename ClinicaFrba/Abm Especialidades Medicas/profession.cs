...
namespace ClinicaFrba.Abm_Especialidades_Medicas
{
    class Profession
    {
        ...
        {
            String query = "SELECT * from group_by.Especialidades where codigo = {0}";
        ...
        {
            String query = "SELECT codigo from group_by.Especialidades where descripcion = '{0}'";
        ...
        {
            String query = "SELECT descripcion from group_by.Especialidades e JOIN group_by.Medico_Especialidad me ON (e.codigo = me.especialidad_codigo) WHERE me.profesional_dni = {0}";
