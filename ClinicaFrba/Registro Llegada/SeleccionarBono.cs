...
namespace ClinicaFrba.Registro_Llegada
{
    public partial class SeleccionarBono : Form
    {
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            String query = "INSERT INTO Atencion_Medica(fecha_efectivizacion, nro_bono, turno_numero) VALUES(GETDATE(), {0}, {1})";
        ...
        private void SeleccionarBono_Load(object sender, EventArgs e)
        {
            ...
            String query = "SELECT Bonos.nro_bono as Numero_De_Bono, Planes_Medicos.descripcion as Plan_Medico, Compras.fecha as Fecha_De_Compra, 'Seleccionar' as Seleccionar FROM Bonos, Planes_Medicos, Compras where Bonos.plan_codigo = Planes_Medicos.codigo and Compras.compra_id = Bonos.compra_id and Bonos.afiliado_dni = {0}";
